...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void MainWindow::on_pushButton_thread_object_construct_2_clicked()
{
    qDebug() << QString::fromUtf8("QThread::currentThread = ") << QThread::currentThread();

    _lz_thread = new LzWorkerThread();

    connect(_lz_thread, &QThread::finished, _lz_thread, &LzWorkerThread::lzThreadFinished);
    connect(_lz_thread, &QThread::started, _lz_thread, &LzWorkerThread::lzThreadStarted);
    connect(this, &MainWindow::lzSignalAction, _lz_thread, &LzWorkerThread::lzThreadRunning);
}

void MainWindow::on_pushButton_thread_start_2_clicked()
{
    _lz_thread->start();
}

void MainWindow::on_pushButton_thread_action_2_clicked()
{
    emit lzSignalAction();
}

void MainWindow::on_pushButton_thread_quit_2_clicked()
{
    qDebug() << QString::fromUtf8("1 isRunning = ") << _lz_thread->isRunning();
    _lz_thread->quit();
    qDebug() << QString::fromUtf8("quit");
    //_lz_thread->wait();
    qDebug() << _lz_thread;
    qDebug() << QString::fromUtf8("2 isRunning = ") << _lz_thread->isRunning();
}

void MainWindow::on_pushButton_thread_exit_2_clicked()
{
    qDebug() << QString::fromUtf8("isRunning = ") << _lz_thread->isRunning();
    _lz_thread->exit();
    qDebug() << QString::fromUtf8("exit");
    //_lz_thread->wait();
    qDebug() << _lz_thread;
...
void MainWindow::on_pushButton_thread_terminate_2_clicked()
{
    qDebug() << QString::fromUtf8("isRunning = ") << _lz_thread->isRunning();
    _lz_thread->terminate();
    qDebug() << QString::fromUtf8("terminate");
    _lz_thread->wait();
    qDebug() << _lz_thread;
    qDebug() << QString::fromUtf8("isRunning = ") << _lz_thread->isRunning();
...
void MainWindow::on_pushButton_thread_object_delete_2_clicked()
{
    disconnect(_lz_thread, &QThread::finished, _lz_thread, &LzWorkerThread::lzThreadFinished);
    disconnect(_lz_thread, &QThread::started, _lz_thread, &LzWorkerThread::lzThreadStarted);
    disconnect(this, &MainWindow::lzSignalAction, _lz_thread, &LzWorkerThread::lzThreadRunning);
